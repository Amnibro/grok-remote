export function initMotion(ctx){
  ...
  function keepIdle(clip){return holdGaze(clip)||(curBase===HOME&&RIGHT.has(clip))||(curBase==="talking_on_phone"&&LEFT.has(clip))}
