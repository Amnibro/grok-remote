export function initMotion(ctx){
  ...
  const HEAD=new Set(["module_check","machinamachina_spark"]),SOFT=new Set(["module_check","machinamachina_spark","chin_think"]),LEFT=new Set(["waist_side_stretch","sun_salute","chin_think","interact"]),RIGHT=new Set(["look_over_shoulder","dismissing_gesture","point_ahead","salute","wave_hello","hand_on_heart","bow_apology"]);
