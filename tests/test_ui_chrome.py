...
def test_idle_chain_uses_seamless_mixamo():
    ...
    assert '"standing_w_briefcase_idle": 244.0' in srv[srv.find("IDLE_DWELL"):srv.find("LIFE =")]
    assert '"talking_on_phone": 244.0' in srv[srv.find("IDLE_DWELL"):srv.find("LIFE =")]
    assert '"guitar_playing": 244.0' in srv[srv.find("IDLE_DWELL"):srv.find("LIFE =")]
